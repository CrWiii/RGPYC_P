...
<div class="container-fluid spark-screen">
		<div class="row">
			<div class="col-md-12 col-md-offset-2" style="margin-left: 0px;padding: 0px;">
				<form action="/storeRamo" method="post" autocomplete="off">
					{{csrf_field()}}
				 	<div class="box">
	        				...
	        				<div class="col-md-8">
		        				<div class="col-md-12" style="margin:0; color:#555;  border:1px solid #a79a9a; padding:20px 10px 10px 10px;margin-bottom: 10px; ">
		        					<div class="col-md-12 col-md-12 form-group row">
										...
										<label class="col-sm-2 col-form-label sizePadding">Area</label>
											<div class="col-md-4">
											 	<div class="form-group{{ $errors->has('area_id') ? ' has-error' : '' }}">
													<input type="text" class="form-control input-sm" name="area_id" value="{{ old('area_id') }}" >		
													<!-- <input class="form-control input-sm" placeholder=".input-sm"> -->
									...
									<div class="col-md-12 col-md-12 form-group row">
										...
										<a href="{{url('ListaCias')}}" class="btn btn-default btn-sm">Cancelar</a> 
		        					</div>
		        				</div>
							</div>
						</div>

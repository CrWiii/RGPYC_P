			...
			<div class="box">
				<div class="box-header with-border" style="width:100%;padding: 5px;">
					...
					<div class="box-body" style="padding:5px;">
			        		<!-- <div class="col-md-10">
			        			<a href="/CrearBroker" class="btn btn-info">Nuevo broker</a>
			        		</div> -->
			        				...
			        				<div class="table-responsive">
			        					<table id="nom"  width="100%" border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-striped" style="white-space: nowrap;font-size: 11px !important; table-layout:fixed;">
													<tr class="info">
														...
														<th style="padding-bottom: 4px;padding-top: 4px !important;">Código</th>
													...
													@foreach($areas as $area)
														<tr>
															<td style="padding: 3px !important"><a href="{{URL::to('/MostrarArea', array('id'=>$area->id))}}">{{$area->description}}</a></td>
															<td style="padding: 3px !important">{{$area->code}}</td>
															<td style="padding: 3px !important; text-align: center;">@if ($area->state ==1 ) Activo @else Inactivo @endif </td>
															<td style="padding: 2px !important">
																<a href="{{URL::to('/EditarArea', array('id'=>$area->id))}}" class="btn btn-success btn-xs">Editar</a> 
																<a href="{{URL::to('/EliminarArea', array('id'=>$area->id))}}" class="btn btn-danger btn-xs">Eliminar</a>
 
																@if($area->state == 0)
																	<a href="{{URL::to('/habilitarArea', array('id'=>$area->id))}}" class="btn btn-info btn-xs">Habilitar</a>
																@else
																	<a href="{{URL::to('/deshabilitarArea', array('id'=>$area->id))}}" class="btn btn-info btn-xs">Deshabilitar</a>
																@endif
															</td>
														</tr>
													@endforeach

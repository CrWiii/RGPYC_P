                            ...
                            <div class="login-box-body" style="border: 2px solid #3c8dbc;border-radius: 10px;">
                                <p class="login-box-msg"> Datos de Usuario </p>
                                    ...
                                    <div class="form-group has-feedback">
                                        <label>Email:</label>
                                        <input type="email" class="form-control input-sm @if($errors->has('email')) error-box @endif" placeholder="{{trans('message.email')}}" id="email" name="email" value="{{$user->email}}" disabled="disabled"/>
                                    ...
                                    <div class="form-group has-feedback">
                                        <label>Dni:</label>
                                        <input type="text" class="form-control input-sm" placeholder="dni" id="dni" name="dni" value="{{$user->dni}}"/>
                                        <span class="glyphicon glyphicon-modal-window form-control-feedback"></span>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <label>Nombres:</label>
                                        <input type="text" class="form-control input-sm @if($errors->has('nombres')) error-box @endif" placeholder="Nombres" id="nombres" name="nombres" value="{{$user->Persona->nombres}}"/>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control input-sm @if($errors->has('apellido_paterno')) error-box @endif" placeholder="Apellido Paterno" id="apellido_paterno" name="apellido_paterno" value="{{$user->Persona->apellido_paterno}}"/>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="text" class="form-control input-sm" placeholder="Apellido Materno" id="apellido_materno" name="apellido_materno" value="{{$user->Persona->apellido_materno}}"/>
                                        <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                    </div>
                                    <div class="form-group has-feedback">
                                        <label>Teléfono:</label>
                                        <input type="text" class="form-control input-sm" placeholder="Telefono" id="telefono" name="telefono" value="{{$user->Persona->telefono}}"/>
                                        <span class="glyphicon glyphicon-earphone form-control-feedback"></span>
                                    </div>                    
                                    <div class="form-group has-feedback">
                                        <label>Cargo:</label>
                                        <input type="text" class="form-control input-sm" placeholder="Cargo" id="cargo" name="cargo" value="{{$user->Persona->cargo}}"/>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <select class="form-control input-sm @if($errors->has('tipo_usuario')) error-box @endif" id="tipo_usuario" name="tipo_usuario" tabindex="-1" aria-hidden="true">
                                            ...
                                            <option value="{{$tipo_usuario->id}}" @if($user->tipo_usuario == $tipo_usuario->id) selected="selected" @endif>{{$tipo_usuario->description}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <select class="form-control input-sm @if($errors->has('profile_id')) error-box @endif" id="profile_id" name="profile_id" tabindex="-1" aria-hidden="true">
                                            ...
                                            @foreach($perfiles as $perfil)
                                                <option value="{{$perfil->id}}" @if($user->profile_id == $perfil->id) selected="selected" @endif>{{$perfil->description}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group has-feedback" id="cia_block">
                                        ...
                                        <select class="form-control input-sm @if($errors->has('cia_id')) error-box @endif" name="cia_id" id="cia_id">
                                            ...
                                            @foreach($cias as $cia)
                                            <option value="{{$cia->id}}" @if($user->cia_id == $cia->id) selected="selected" @endif>{{$cia->nombre_comercial}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group has-feedback" id="area_block">
                                        ...
                                        <select class="form-control input-sm select2" multiple="" id="areas" name="areas[]" style="width: 100%" tabindex="-1" aria-hidden="true">
                                                ...
                                                <option value="{{$area->id}}" @if(in_array($area->id,$areas_asignadas)) selected @endif>{{$area->description}}</option>
                                                @endforeach
                                        </select>
                                        @if($errors->has('Areas'))
                                            <span class="help-block">
                                        ...
                                        <div class="box-body">
                                          ...
                                          <ul class="todo-list ui-sortable" id="permisos">
                                            ...
                                            <li id="permiso" data-id="{{$rol->id}}">
                                              <input type="checkbox" value="{{$rol->id}}" id="rol" data-id='{{$rol->id}}' name="roles[]" @if(in_array($rol->id,$permisos)) checked="checked" @endif>

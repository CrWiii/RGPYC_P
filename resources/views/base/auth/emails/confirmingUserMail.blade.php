          ...
          <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
            <tr>
              <td style="text-align: center;">
                <a href="#"><img class="w320" width="311" src="https://sr2.pe/img/logo.jpg" alt="company logo" style="padding-top: 20px;" ></a>
              </td>
            </tr>
          </table>
            ...
            <tr>
              ...
              <table cellspacing="0" cellpadding="0" width="100%">
                <tr>
                  ...
                  <br>
                    Se le ha habilitado acceso en el portal MEDI-K <br>
                    Para tu referencia, tu usuario es tu email: <strong style="font-size: 1.1em">{{$email}}</strong><br>
                    Su cuenta fue registrada con exito ahora solo falta activarla y fijar su contraseña en el siguiente enlace: 


<!--                     Se le ha habilitado acceso al portal SR2 <br>
                    tus credenciales de acceso son las siguiente: <br>
                    Usuario: <br>

                    Para acceder al portal deberas de ingresar al siguiente link:
                    <a href="https://sr2.pe">https://sr2.pe</a> -->
               ...
               <table style="margin:0 auto;" cellspacing="0" cellpadding="10" width="100%">
                <tr>
                  <td style="text-align:center; margin:0 auto;">
                    <div>
                          <a href="{{URL::to('ActivarUsuario', array('email' => $email))}}" class="ggi">Activar Usuario</a>
                    </div>
                    <br>
                  </td>
                </tr>
